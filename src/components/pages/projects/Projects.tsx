...
const Projects = () => {
    ...
    const projects = [
        ...
        { title: "Stringy Backend", description: "Backend for the Stringy application.", tags: ["Node.js", "Express.js", "JWT", "Google Cloud SQL", "Google Cloud Platform"] },
        ...
        { title: "ChadChat", description: "An Interactive Real-Time Chat Application.", gh_url: "https://github.com/MrWinRock/ChadChat", tags: ["React Native", "Typescript"] },
        { title: "ChadChat Backend", description: "Backend for the ChadChat application.", gh_url: "https://github.com/MrWinRock/chadchat-backend", tags: ["Node.js", "Express.js", "Socket.io", "MongoDB"] },
