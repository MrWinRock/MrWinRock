...
const Projects = () => {
    ...
    const projects = [
        ...
        { title: "MrWinRock API", description: "Backend API powering portfolio functionality.", url: "https://api.mrwinrock.com/", gh_url: "https://github.com/MrWinRock/mrwinrock-app", tags: ["Bun", "Hono", "Zod", "Fly.io", "Cloudflare"] },
